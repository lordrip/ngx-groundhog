...
import {GhContextDialogModule, GhContextDialog} from './index';
...
describe('GhContextDialog', () => {
  let overlayContainer: OverlayContainer;
  let overlayContainerElement: HTMLElement;
  let platform: Platform;

  function configureGhContextDialogTestingModule(declarations) {
  ...
  describe('core', () => {
    beforeEach(async(() => {
      configureGhContextDialogTestingModule([
        BasicContextDialog
      ]);
    }));
    describe('accessibility', () => {
      describe('for context-dialog', () => {
        ...
        it('should be able to focus the context dialog', fakeAsync(() => {
          ...
          expect(document.activeElement).toBe(contextDialog,
...
class BasicContextDialog {
  ...
  @ViewChild(GhContextDialog) contextDialog: GhContextDialog;
}
